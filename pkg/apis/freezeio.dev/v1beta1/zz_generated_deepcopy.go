...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VFSFSAL) DeepCopyInto(out *VFSFSAL) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VFSFSAL.
func (in *VFSFSAL) DeepCopy() *VFSFSAL {
	if in == nil {
		return nil
	}
	out := new(VFSFSAL)
